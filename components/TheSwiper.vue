...
// при перезагрузке оказалось что не работает и стили перекрывают друг друга
// поэтому перенес это в мейн файл
// import 'swiper/scss';
// import 'swiper/scss/navigation';
import { Navigation } from 'swiper';

// попробуй это все в сетап скрипт ставить
export default {
  components: {
    Swiper,
    SwiperSlide,
  ...
  setup() {
    ...
    return {
      modules: [Navigation],
      //   кнопки есть но они не нажимаються
      prev,
      next,
      //   это сам добавил
      onSwiper,
